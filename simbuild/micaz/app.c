...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7b7a458, const void *arg_0xb7b7a5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b2b8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79d5840), 
int (*key_eq_fn)(void *arg_0xb79d5c88, void *arg_0xb79d5e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78a49b8, int arg_0xb78a4b10);
static double RandomUniform(void );
...
typedef TMilli SmartBinC$AlertTimer$precision_tag;
typedef TMilli SmartBinC$BinTravelTime$precision_tag;
typedef TMilli SmartBinC$TruckTravelTime$precision_tag;
typedef TMilli SmartBinC$TimerToCollect$precision_tag;
typedef TMilli SmartBinC$Timer$precision_tag;
...
static void SmartBinC$SplitControl$startDone(error_t error);
#line 138
static void SmartBinC$SplitControl$stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void SmartBinC$Boot$booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void SmartBinC$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SmartBinC$sendTruckMessage$runTask(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBinC$AlertTimer$fired(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SmartBinC$sendMove$runTask(void );
#line 75
static void SmartBinC$sendMoveResponse$runTask(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void SmartBinC$AMSerialSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBinC$BinTravelTime$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void SmartBinC$sendTrashMove$runTask(void );
#line 75
static void SmartBinC$sendAlert$runTask(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void SmartBinC$SerialSplitControl$startDone(error_t error);
#line 138
static void SmartBinC$SerialSplitControl$stopDone(error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBinC$TruckTravelTime$fired(void );
#line 83
static void SmartBinC$TimerToCollect$fired(void );
#line 83
static void SmartBinC$Timer$fired(void );
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SmartBinC$SplitControl$start(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t SmartBinC$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t SmartBinC$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SmartBinC$sendTruckMessage$postTask(void );
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool SmartBinC$AlertTimer$isRunning(void );
#line 64
static void SmartBinC$AlertTimer$startPeriodic(uint32_t dt);
#line 78
static void SmartBinC$AlertTimer$stop(void );
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t SmartBinC$Random$rand16(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SmartBinC$sendMove$postTask(void );
#line 67
static error_t SmartBinC$sendMoveResponse$postTask(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t SmartBinC$AMSerialSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBinC$BinTravelTime$startOneShot(uint32_t dt);
...
SmartBinC$SerialPacket$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
#line 106
static uint8_t SmartBinC$SerialPacket$maxPayloadLength(void );
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t SmartBinC$sendTrashMove$postTask(void );
#line 67
static error_t SmartBinC$sendAlert$postTask(void );
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SmartBinC$SerialSplitControl$start(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t SmartBinC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool SmartBinC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBinC$TruckTravelTime$startOneShot(uint32_t dt);
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t SmartBinC$AMPacket$source(
#line 84
message_t * amsg);
#line 78
static am_addr_t SmartBinC$AMPacket$destination(
#line 74
message_t * amsg);
#line 147
static am_id_t SmartBinC$AMPacket$type(
#line 143
message_t * amsg);
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool SmartBinC$TimerToCollect$isRunning(void );
#line 73
static void SmartBinC$TimerToCollect$startOneShot(uint32_t dt);
#line 73
static void SmartBinC$Timer$startOneShot(uint32_t dt);
# 87 "SmartBinC.nc"
enum SmartBinC$__nesc_unnamed4337 {
#line 87
  SmartBinC$sendAlert = 6U
};
#line 87
typedef int SmartBinC$__nesc_sillytask_sendAlert[SmartBinC$sendAlert];
enum SmartBinC$__nesc_unnamed4338 {
#line 88
  SmartBinC$sendMove = 7U
};
#line 88
typedef int SmartBinC$__nesc_sillytask_sendMove[SmartBinC$sendMove];
enum SmartBinC$__nesc_unnamed4339 {
#line 89
  SmartBinC$sendTruckMessage = 8U
};
#line 89
typedef int SmartBinC$__nesc_sillytask_sendTruckMessage[SmartBinC$sendTruckMessage];
enum SmartBinC$__nesc_unnamed4340 {
#line 90
  SmartBinC$sendTrashMove = 9U
};
#line 90
typedef int SmartBinC$__nesc_sillytask_sendTrashMove[SmartBinC$sendTrashMove];
enum SmartBinC$__nesc_unnamed4341 {
#line 91
  SmartBinC$sendMoveResponse = 10U
};
#line 91
typedef int SmartBinC$__nesc_sillytask_sendMoveResponse[SmartBinC$sendMoveResponse];
#line 31
bool SmartBinC$busy[1000];

uint8_t SmartBinC$garbageInBin[1000];
message_t SmartBinC$packet[1000];
uint32_t SmartBinC$time[1000];
uint16_t SmartBinC$garbageToAdd[1000];
uint8_t SmartBinC$coordinateX[1000];
uint8_t SmartBinC$coordinateY[1000];
uint16_t SmartBinC$delay[1000];


uint16_t SmartBinC$newCoordX[1000];
uint16_t SmartBinC$newCoordY[1000];

uint16_t SmartBinC$targetID[1000];

uint16_t SmartBinC$closestBin[1000];
uint16_t SmartBinC$smallerDistance[1000];
uint16_t SmartBinC$trashInExcess[1000];

static inline void SmartBinC$Boot$booted(void );
#line 66
static inline void SmartBinC$SerialSplitControl$startDone(error_t err);
static inline void SmartBinC$SerialSplitControl$stopDone(error_t err);

static inline void SmartBinC$SplitControl$startDone(error_t err);
#line 85
static inline void SmartBinC$SplitControl$stopDone(error_t err);
...
static void SmartBinC$sendSerialPacket(uint8_t _packetType, uint16_t _bin_id, uint16_t _coordX, uint16_t _coordY, uint16_t _trashInExcess);


static void SmartBinC$sendSerialPacket(uint8_t _packetType, uint16_t _bin_id, uint16_t _coordX, uint16_t _coordY, uint16_t _trashInExcess);
#line 113
static inline void SmartBinC$sendAlert$runTask(void );
#line 144
static inline void SmartBinC$sendMove$runTask(void );
#line 175
static inline void SmartBinC$sendTruckMessage$runTask(void );
#line 195
static inline void SmartBinC$sendMoveResponse$runTask(void );
#line 227
static inline void SmartBinC$sendTrashMove$runTask(void );
#line 258
static inline void SmartBinC$AMSerialSend$sendDone(message_t *buf, error_t err);

static void SmartBinC$AMSend$sendDone(message_t *buf, error_t err);
#line 303
static inline message_t *SmartBinC$Receive$receive(message_t *buf, void *payload, uint8_t len);
#line 434
static inline void SmartBinC$TruckTravelTime$fired(void );
...
static inline void SmartBinC$BinTravelTime$fired(void );




static inline void SmartBinC$Timer$fired(void );
#line 481
static inline void SmartBinC$TimerToCollect$fired(void );
...
static inline void SmartBinC$AlertTimer$fired(void );
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static error_t /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 147 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_id_t SmartBinC$AMPacket$type(message_t * amsg){
#line 147
...
#line 147
#line 78
inline static am_addr_t SmartBinC$AMPacket$destination(message_t * amsg){
#line 78
  unsigned short __nesc_result;
#line 78
...
inline static am_addr_t SmartBinC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static bool SmartBinC$TimerToCollect$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBinC$BinTravelTime$startOneShot(uint32_t dt){
#line 73
...
inline static void SmartBinC$AlertTimer$stop(void ){
#line 78
...
#line 78
#line 73
inline static void SmartBinC$TruckTravelTime$startOneShot(uint32_t dt){
#line 73
...
#line 303
{
  ...
  if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 1) {
      sim_log_debug(222U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(223U, "radio_pack", "ALERT message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(224U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(225U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(226U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(227U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(228U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(229U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(230U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(231U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(232U, "radio_pack", "\n");
      if (!SmartBinC$busy[sim_node()]) {
          SmartBinC$busy[sim_node()] = TRUE;
          SmartBinC$delay[sim_node()] = sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2));
          SmartBinC$TruckTravelTime$startOneShot(1 * SmartBinC$delay[sim_node()] * 1000);
          sim_log_debug(233U, "radio_rec", "The truck will be there in %d s.\n", 1 * SmartBinC$delay[sim_node()]);

          SmartBinC$targetID[sim_node()] = __nesc_ntoh_uint16(mess->bin_id.nxdata);
          SmartBinC$newCoordX[sim_node()] = __nesc_ntoh_uint16(mess->coordX.nxdata);
          SmartBinC$newCoordY[sim_node()] = __nesc_ntoh_uint16(mess->coordY.nxdata);
        }
      else 
#line 327
        {
          sim_log_debug(234U, "radio_rec", "The truck is busy -> discard the message!\n");
        }
    }

  if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 2) {
      sim_log_debug(235U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(236U, "radio_pack", "TRUCK message>>>Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(237U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(238U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(239U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(240U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(241U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(242U, "radio_rec", "\n ");
      sim_log_debug_clear(243U, "radio_pack", "\n");

      SmartBinC$garbageInBin[sim_node()] = 0;
      sim_log_debug(244U, "SmartBinC", "Emptying bin...\n");
      SmartBinC$AlertTimer$stop();
    }


  if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 3 && TOS_NODE_ID != 0) {
      sim_log_debug(245U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(246U, "radio_pack", "MOVE message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(247U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(248U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(249U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(250U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(251U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(252U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(253U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(254U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(255U, "radio_rec", "\n ");
      sim_log_debug_clear(256U, "radio_pack", "\n");

      if (SmartBinC$garbageInBin[sim_node()] < 85) {
          SmartBinC$delay[sim_node()] = sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2));
          SmartBinC$targetID[sim_node()] = __nesc_ntoh_uint16(mess->bin_id.nxdata);
          SmartBinC$BinTravelTime$startOneShot(0.05 * SmartBinC$delay[sim_node()] * 1000);
          sim_log_debug(257U, "radio_rec", "Bin response will be there in %f s.\n", SmartBinC$delay[sim_node()] * 0.05);
        }
      else 
#line 368
        {
          sim_log_debug(258U, "radio_rec", "Bin in critical status -> discard the message\n");
        }
    }

  if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 4) {
      sim_log_debug(259U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(260U, "radio_pack", "RESP_MOVE message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(261U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(262U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(263U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(264U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(265U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(266U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(267U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(268U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(269U, "radio_rec", "\n ");
      sim_log_debug_clear(270U, "radio_pack", "\n");

      if (SmartBinC$TimerToCollect$isRunning()) {
          SmartBinC$targetID[sim_node()] = __nesc_ntoh_uint16(mess->bin_id.nxdata);
          if (SmartBinC$closestBin[sim_node()] == 0 && SmartBinC$smallerDistance[sim_node()] == 0) {
              SmartBinC$closestBin[sim_node()] = __nesc_ntoh_uint16(mess->bin_id.nxdata);
              SmartBinC$smallerDistance[sim_node()] = sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2));
              sim_log_debug(271U, "SmartBinC", "Arrived first response. New closestBin: %d, new smallerDistance: %d\n", SmartBinC$closestBin[sim_node()], SmartBinC$smallerDistance[sim_node()]);
            }
          else 
#line 393
            {
              if (SmartBinC$smallerDistance[sim_node()] > sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2))) {
                  SmartBinC$closestBin[sim_node()] = __nesc_ntoh_uint16(mess->bin_id.nxdata);
                  SmartBinC$smallerDistance[sim_node()] = sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2));
                  sim_log_debug(272U, "SmartBinC", "Arrived another response of a bin closer to me. New closestBin: %d, new smallerDistance: %d\n", SmartBinC$closestBin[sim_node()], SmartBinC$smallerDistance[sim_node()]);
                }
              else 
#line 398
                {
                  sim_log_debug(273U, "SmartBinC", "Arrived response. closestBin: %d, smallerDistance: %d and nothing changed\n", SmartBinC$closestBin[sim_node()], SmartBinC$smallerDistance[sim_node()]);
                }
            }
        }
      else 
#line 402
        {
          sim_log_debug(274U, "SmartBinC", "Received packet but TimerToCollect is over!\n");
        }
    }

  if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 5) {
      sim_log_debug(275U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(276U, "radio_pack", "TRASH_MOVE message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(277U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(278U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(279U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(280U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(281U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(282U, "radio_pack", "\t\t trashInExcess: %hhu \n", __nesc_ntoh_uint16(mess->trashInExcess.nxdata));
      sim_log_debug_clear(283U, "radio_rec", "\n ");
      sim_log_debug_clear(284U, "radio_pack", "\n");

      if (SmartBinC$garbageInBin[sim_node()] + __nesc_ntoh_uint16(mess->trashInExcess.nxdata) >= 100) {
          SmartBinC$garbageInBin[sim_node()] = 100;
          SmartBinC$trashInExcess[sim_node()] = SmartBinC$trashInExcess[sim_node()] + SmartBinC$garbageInBin[sim_node()] + __nesc_ntoh_uint16(mess->trashInExcess.nxdata) - 100;
          sim_log_debug(285U, "radio_rec", "Arrived trash - Uploaded garbage in bin: %d, trash in excess: %d \n", SmartBinC$garbageInBin[sim_node()], SmartBinC$trashInExcess[sim_node()]);
        }
      else 
#line 423
        {
          SmartBinC$garbageInBin[sim_node()] = SmartBinC$garbageInBin[sim_node()] + __nesc_ntoh_uint16(mess->trashInExcess.nxdata);
          sim_log_debug(286U, "radio_rec", "Arrived trash - Uploaded garbage in bin: %d\n", SmartBinC$garbageInBin[sim_node()]);
        }
    }
...
#line 78
    case 6:
#line 78
      __nesc_result = SmartBinC$Receive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7621178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7621178, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * SerialActiveMessageC$Receive$receive(am_id_t arg_0xb7508548, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = SerialActiveMessageC$Receive$default$receive(arg_0xb7508548, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SmartBinC$SplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t SmartBinC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 69
{
  SmartBinC$time[sim_node()] = SmartBinC$Random$rand16();
  SmartBinC$time[sim_node()] = SmartBinC$time[sim_node()] % 29000;
  if (err == SUCCESS) {
      sim_log_debug(155U, "radio", "Radio on!\n");

      if (TOS_NODE_ID != 0) {

          SmartBinC$Timer$startOneShot(SmartBinC$time[sim_node()]);
        }
    }
  else 
#line 79
...
#line 113
  SmartBinC$SplitControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  SmartBinC$SplitControl$stopDone(error);
#line 138
}
#line 138
...
#line 113
  SmartBinC$SerialSplitControl$startDone(error);
#line 113
}
#line 113
# 74 "/opt/tinyos-main-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
...
#line 138
  SmartBinC$SerialSplitControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void SerialActiveMessageC$AMSend$sendDone(am_id_t arg_0xb7509ae8, message_t * msg, error_t error){
#line 110
  switch (arg_0xb7509ae8) {
#line 110
    case AM_SERIAL_MSG:
#line 110
      SmartBinC$AMSerialSend$sendDone(msg, error);
#line 110
      break;
#line 110
    default:
#line 110
      SerialActiveMessageC$AMSend$default$sendDone(arg_0xb7509ae8, msg, error);
#line 110
      break;
#line 110
    }
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SmartBinC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * SmartBinC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 113
{
  ...
  my_msg_t *mess = (my_msg_t *)SmartBinC$Packet$getPayload(&SmartBinC$packet[sim_node()], sizeof(my_msg_t ));

#line 116
  __nesc_hton_uint16(mess->msg_type.nxdata, 1);
  __nesc_hton_uint16(mess->bin_id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mess->coordX.nxdata, SmartBinC$coordinateX[sim_node()]);
  __nesc_hton_uint16(mess->coordY.nxdata, SmartBinC$coordinateY[sim_node()]);

  sim_log_debug(157U, "radio_send", "time: %s - sendAlert() - Try to send a request to TRUCK\n", sim_time_string());

  SmartBinC$sendSerialPacket(1, TOS_NODE_ID, SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()], SmartBinC$trashInExcess[sim_node()]);


  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(0, &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(158U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(159U, "radio_pack", "\t Source: %hhu \n ", SmartBinC$AMPacket$source(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(160U, "radio_pack", "\t Destination: %hhu \n ", SmartBinC$AMPacket$destination(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(161U, "radio_pack", "\t AM Type: %hhu \n ", SmartBinC$AMPacket$type(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(162U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(163U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(164U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(165U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(166U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(167U, "radio_send", "\n ");
      sim_log_debug_clear(168U, "radio_pack", "\n");
      SmartBinC$busy[sim_node()] = TRUE;
    }
  else 
#line 139
    {
      sim_log_debug(169U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}
...
#line 147
  __nesc_hton_uint16(mess->msg_type.nxdata, 3);
  __nesc_hton_uint16(mess->bin_id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mess->coordX.nxdata, SmartBinC$coordinateX[sim_node()]);
  __nesc_hton_uint16(mess->coordY.nxdata, SmartBinC$coordinateY[sim_node()]);

  sim_log_debug(170U, "radio_send", "time: %s - sendMove() - Try to send a request to all other BINS\n", sim_time_string());

  SmartBinC$sendSerialPacket(3, TOS_NODE_ID, SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()], SmartBinC$trashInExcess[sim_node()]);

  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(AM_BROADCAST_ADDR, &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(177U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(178U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(179U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
...
#line 170
    {
      sim_log_debug(182U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}

# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t SmartBinC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
#line 177
  __nesc_hton_uint16(mess->msg_type.nxdata, 2);

  SmartBinC$sendSerialPacket(2, TOS_NODE_ID, SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()], SmartBinC$trashInExcess[sim_node()]);

  sim_log_debug(183U, "radio_send", "time: %s - sendTruckMessage() - Try to send a response to BIN %d\n", sim_time_string(), SmartBinC$targetID[sim_node()]);
  SmartBinC$PacketAcknowledgements$requestAck(&SmartBinC$packet[sim_node()]);
  if (SmartBinC$AMSend$send(SmartBinC$targetID[sim_node()], &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(190U, "radio_send", "\n ");
      sim_log_debug_clear(191U, "radio_pack", "\n");
    }
}
...
#line 230
  __nesc_hton_uint16(mess->msg_type.nxdata, 5);
  __nesc_hton_uint16(mess->trashInExcess.nxdata, SmartBinC$trashInExcess[sim_node()]);

  sim_log_debug(205U, "radio_send", "time: %s - sendTrashMove() - Move trash of %d to %d \n", sim_time_string(), SmartBinC$trashInExcess[sim_node()], SmartBinC$closestBin[sim_node()]);


  SmartBinC$PacketAcknowledgements$requestAck(&SmartBinC$packet[sim_node()]);

  SmartBinC$sendSerialPacket(5, TOS_NODE_ID, SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()], SmartBinC$trashInExcess[sim_node()]);

  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(SmartBinC$closestBin[sim_node()], &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(206U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(207U, "radio_pack", "\t Source: %hhu \n ", SmartBinC$AMPacket$source(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(208U, "radio_pack", "\t Destination: %hhu \n ", SmartBinC$AMPacket$destination(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(209U, "radio_pack", "\t AM Type: %hhu \n ", SmartBinC$AMPacket$type(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(210U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(211U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(212U, "radio_pack", "\t\t trashInExcess: %hhu \n", __nesc_ntoh_uint16(mess->trashInExcess.nxdata));
      sim_log_debug_clear(213U, "radio_send", "\n ");
...
#line 252
    {
      sim_log_debug(215U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}
...
#line 198
  __nesc_hton_uint16(mess->msg_type.nxdata, 4);
  __nesc_hton_uint16(mess->bin_id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mess->coordX.nxdata, SmartBinC$coordinateX[sim_node()]);
  __nesc_hton_uint16(mess->coordY.nxdata, SmartBinC$coordinateY[sim_node()]);

  sim_log_debug(192U, "radio_send", "time: %s - sendMoveResponse() - Try to send a response to BIN %d\n", sim_time_string(), SmartBinC$targetID[sim_node()]);

  SmartBinC$sendSerialPacket(4, TOS_NODE_ID, SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()], SmartBinC$trashInExcess[sim_node()]);


  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(SmartBinC$targetID[sim_node()], &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(193U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(194U, "radio_pack", "\t Source: %hhu \n ", SmartBinC$AMPacket$source(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(195U, "radio_pack", "\t Destination: %hhu \n ", SmartBinC$AMPacket$destination(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(196U, "radio_pack", "\t AM Type: %hhu \n ", SmartBinC$AMPacket$type(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(197U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(198U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint16(mess->msg_type.nxdata));
      sim_log_debug_clear(199U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(200U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(201U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(202U, "radio_send", "\n ");
      sim_log_debug_clear(203U, "radio_pack", "\n");
...
#line 222
    {
      sim_log_debug(204U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  SmartBinC$AMSend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7221ca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7221ca8) {
#line 100
    case 0U:
#line 100
      /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7221ca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7bb2b28){
#line 75
  switch (arg_0xb7bb2b28) {
#line 75
...
#line 75
      break;
#line 75
    case SmartBinC$sendAlert:
#line 75
      SmartBinC$sendAlert$runTask();
#line 75
      break;
#line 75
    case SmartBinC$sendMove:
#line 75
      SmartBinC$sendMove$runTask();
#line 75
      break;
#line 75
    case SmartBinC$sendTruckMessage:
#line 75
      SmartBinC$sendTruckMessage$runTask();
#line 75
      break;
#line 75
    case SmartBinC$sendTrashMove:
#line 75
      SmartBinC$sendTrashMove$runTask();
#line 75
      break;
#line 75
    case SmartBinC$sendMoveResponse:
#line 75
      SmartBinC$sendMoveResponse$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7bb2b28);
#line 75
      break;
#line 75
    }
...
inline static bool SmartBinC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
#line 85
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBinC$TimerToCollect$startOneShot(uint32_t dt){
#line 73
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb721e730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb721e730, addr, msg, len);
#line 80
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SmartBinC$sendMove$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBinC$sendMove);
#line 67
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void SmartBinC$AlertTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 64
#line 92
inline static bool SmartBinC$AlertTimer$isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
{
  SmartBinC$time[sim_node()] = SmartBinC$Random$rand16();
  SmartBinC$garbageToAdd[sim_node()] = SmartBinC$Random$rand16();

  SmartBinC$time[sim_node()] = SmartBinC$time[sim_node()] % 29000;
  SmartBinC$garbageToAdd[sim_node()] = SmartBinC$garbageToAdd[sim_node()] % 9;
  SmartBinC$time[sim_node()] = SmartBinC$time[sim_node()] + 1000;
  SmartBinC$garbageToAdd[sim_node()] = SmartBinC$garbageToAdd[sim_node()] + 1;

  if (SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] < 85) {

      SmartBinC$garbageInBin[sim_node()] = SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()];
      sim_log_debug(289U, "SmartBinC", "time: %s - Adding garbage: %d, Excess already present: %d, Garbage level: %d -> Normal status\tNext time: %d\n", sim_time_string(), SmartBinC$garbageToAdd[sim_node()], SmartBinC$trashInExcess[sim_node()], SmartBinC$garbageInBin[sim_node()], SmartBinC$time[sim_node()]);
    }
  else {
    if (SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] >= 85 && SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] < 100) {

        SmartBinC$garbageInBin[sim_node()] = SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()];
        sim_log_debug(290U, "SmartBinC", "time: %s - Adding garbage: %d, Excess already present: %d, Garbage level: %d -> Critical status\tNext time: %d\n", sim_time_string(), SmartBinC$garbageToAdd[sim_node()], SmartBinC$trashInExcess[sim_node()], SmartBinC$garbageInBin[sim_node()], SmartBinC$time[sim_node()]);

        if (!SmartBinC$AlertTimer$isRunning()) {
#line 466
          SmartBinC$AlertTimer$startPeriodic(5000);
          }
      }
    else {
#line 469
      if (SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] >= 100) {
          SmartBinC$trashInExcess[sim_node()] = SmartBinC$trashInExcess[sim_node()] + SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] - 100;
          SmartBinC$garbageInBin[sim_node()] = 100;
          sim_log_debug(291U, "SmartBinC", "time: %s - Adding garbage: %d, Excess already present: %d, Garbage level: %d-> Full status\tNext time: %d\n", sim_time_string(), SmartBinC$garbageToAdd[sim_node()], SmartBinC$trashInExcess[sim_node()], SmartBinC$garbageInBin[sim_node()], SmartBinC$time[sim_node()]);

          SmartBinC$sendMove$postTask();
        }
      }
    }
  SmartBinC$Timer$startOneShot(SmartBinC$time[sim_node()]);
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SmartBinC$sendTruckMessage$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBinC$sendTruckMessage);
#line 67
...
#line 434
{
  SmartBinC$coordinateX[sim_node()] = SmartBinC$newCoordX[sim_node()];
  SmartBinC$coordinateY[sim_node()] = SmartBinC$newCoordY[sim_node()];
  sim_log_debug(287U, "SmartBinC", "TruckTravelTime fired -> Truck is arrived at coordinates: (%d, %d)\n", SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()]);
  SmartBinC$sendTruckMessage$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SmartBinC$sendMoveResponse$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBinC$sendMoveResponse);
#line 67
...
#line 441
{
  sim_log_debug(288U, "SmartBinC", "BinTravelTime fired\n");
  SmartBinC$sendMoveResponse$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SmartBinC$sendTrashMove$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBinC$sendTrashMove);
#line 67
...
#line 481
{
  sim_log_debug(292U, "SmartBinC", "TimerToCollect is over!\n");
  if (SmartBinC$closestBin[sim_node()] == 0 && SmartBinC$smallerDistance[sim_node()] == 0) {
      sim_log_error(293U, "SmartBinC", "It has not been found an available bin near to me\n");
      SmartBinC$trashInExcess[sim_node()] = 0;
    }
  else 
#line 486
    {
      SmartBinC$sendTrashMove$postTask();
    }
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t SmartBinC$sendAlert$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(SmartBinC$sendAlert);
#line 67
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb7283c70){
#line 83
  switch (arg_0xb7283c70) {
#line 83
    case 0U:
#line 83
      SmartBinC$Timer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      SmartBinC$TruckTravelTime$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      SmartBinC$BinTravelTime$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      SmartBinC$TimerToCollect$fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      SmartBinC$AlertTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb7283c70);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(320U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(319U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(316U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(317U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(309U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(299U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(306U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 78
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * SmartBinC$SerialPacket$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 126
#line 106
inline static uint8_t SmartBinC$SerialPacket$maxPayloadLength(void ){
#line 106
  unsigned char __nesc_result;
#line 106
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t SmartBinC$AMSerialSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 364
{
  sim_log_debug(311U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SmartBinC$SerialSplitControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 51
{
  ...
  SmartBinC$coordinateX[sim_node()] = SmartBinC$Random$rand16();
  SmartBinC$coordinateX[sim_node()] = SmartBinC$coordinateX[sim_node()] % 30;

  SmartBinC$coordinateY[sim_node()] = SmartBinC$Random$rand16();
  SmartBinC$coordinateY[sim_node()] = SmartBinC$coordinateY[sim_node()] % 30;
  sim_log_debug(154U, "boot", "Coordinates of the mote are: (%d, %d)\n", SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()]);

  SmartBinC$SplitControl$start();
  SmartBinC$SerialSplitControl$start();
}

# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
inline static void SimMainP$Boot$booted(void ){
#line 60
  SmartBinC$Boot$booted();
#line 60
}
#line 60
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
static uint8_t SmartBinC$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 285
  ...
  sim_log_debug(308U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(314U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 260
{
  ...
  if (&SmartBinC$packet[sim_node()] == buf && TOS_NODE_ID != 0) {
#line 263
    SmartBinC$busy[sim_node()] = FALSE;
    }
  if (&SmartBinC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(216U, "radio_send", "Packet of type %d sent...", __nesc_ntoh_uint16(mess->msg_type.nxdata));


      if (SmartBinC$PacketAcknowledgements$wasAcked(buf)) {
          if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 2) {
              sim_log_debug_clear(217U, "radio_ack", "and ack received");
              SmartBinC$busy[sim_node()] = FALSE;
            }

          if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 5) {
              sim_log_debug_clear(218U, "radio_ack", "and ack received");

              SmartBinC$trashInExcess[sim_node()] = 0;
              SmartBinC$closestBin[sim_node()] = 0;
              SmartBinC$smallerDistance[sim_node()] = 0;
            }
        }
      else 
#line 282
        {
          if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 3) {

              SmartBinC$TimerToCollect$startOneShot(2000);
            }

          if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 2) {
              sim_log_debug_clear(219U, "radio_ack", "but ack was not received");
              SmartBinC$sendTruckMessage$postTask();
            }

          if (__nesc_ntoh_uint16(mess->msg_type.nxdata) == 5) {
              sim_log_debug_clear(220U, "radio_ack", "but ack was not received");
              SmartBinC$sendTrashMove$postTask();
            }
        }
      sim_log_debug_clear(221U, "radio_send", " at time %s \n", sim_time_string());
    }
}
...
#line 101
      sim_log_debug(294U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(295U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(296U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(297U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(315U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(318U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(307U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 95
{
  ...
  my_msg_t *cm = (my_msg_t *)SmartBinC$SerialPacket$getPayload(&SmartBinC$packet[sim_node()], sizeof(my_msg_t ));
...
#line 99
  if (SmartBinC$SerialPacket$maxPayloadLength() < sizeof(my_msg_t )) {
      return;
    }

  __nesc_hton_uint16(cm->msg_type.nxdata, _packetType);
  __nesc_hton_uint16(cm->bin_id.nxdata, _bin_id);
  __nesc_hton_uint16(cm->coordX.nxdata, _coordX);
  __nesc_hton_uint16(cm->coordY.nxdata, _coordY);
  __nesc_hton_uint16(cm->trashInExcess.nxdata, _trashInExcess);
  if (SmartBinC$AMSerialSend$send(AM_BROADCAST_ADDR, &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(156U, "role", "Serial Packet sent...\n");
    }
}
...
#line 55
{
  /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 6);
  return /*SmartBinAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module SmartBinC */
  if (!strcmp(varname, "SmartBinC$busy"))
  {
    *addr = (uintptr_t)&SmartBinC$busy[__nesc_mote];
    *size = sizeof(SmartBinC$busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$garbageInBin"))
  {
    *addr = (uintptr_t)&SmartBinC$garbageInBin[__nesc_mote];
    *size = sizeof(SmartBinC$garbageInBin[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$packet"))
  {
    *addr = (uintptr_t)&SmartBinC$packet[__nesc_mote];
    *size = sizeof(SmartBinC$packet[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$time"))
  {
    *addr = (uintptr_t)&SmartBinC$time[__nesc_mote];
    *size = sizeof(SmartBinC$time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$garbageToAdd"))
  {
    *addr = (uintptr_t)&SmartBinC$garbageToAdd[__nesc_mote];
    *size = sizeof(SmartBinC$garbageToAdd[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$coordinateX"))
  {
    *addr = (uintptr_t)&SmartBinC$coordinateX[__nesc_mote];
    *size = sizeof(SmartBinC$coordinateX[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$coordinateY"))
  {
    *addr = (uintptr_t)&SmartBinC$coordinateY[__nesc_mote];
    *size = sizeof(SmartBinC$coordinateY[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$delay"))
  {
    *addr = (uintptr_t)&SmartBinC$delay[__nesc_mote];
    *size = sizeof(SmartBinC$delay[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$newCoordX"))
  {
    *addr = (uintptr_t)&SmartBinC$newCoordX[__nesc_mote];
    *size = sizeof(SmartBinC$newCoordX[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$newCoordY"))
  {
    *addr = (uintptr_t)&SmartBinC$newCoordY[__nesc_mote];
    *size = sizeof(SmartBinC$newCoordY[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$targetID"))
  {
    *addr = (uintptr_t)&SmartBinC$targetID[__nesc_mote];
    *size = sizeof(SmartBinC$targetID[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$closestBin"))
  {
    *addr = (uintptr_t)&SmartBinC$closestBin[__nesc_mote];
    *size = sizeof(SmartBinC$closestBin[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$smallerDistance"))
  {
    *addr = (uintptr_t)&SmartBinC$smallerDistance[__nesc_mote];
    *size = sizeof(SmartBinC$smallerDistance[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBinC$trashInExcess"))
  {
    *addr = (uintptr_t)&SmartBinC$trashInExcess[__nesc_mote];
    *size = sizeof(SmartBinC$trashInExcess[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module SmartBinC */
  SmartBinC$busy[__nesc_mote] = FALSE;
  SmartBinC$garbageInBin[__nesc_mote] = 0;
  memset((void *)&SmartBinC$packet[__nesc_mote], 0, sizeof SmartBinC$packet[__nesc_mote]);
  memset((void *)&SmartBinC$time[__nesc_mote], 0, sizeof SmartBinC$time[__nesc_mote]);
  memset((void *)&SmartBinC$garbageToAdd[__nesc_mote], 0, sizeof SmartBinC$garbageToAdd[__nesc_mote]);
  memset((void *)&SmartBinC$coordinateX[__nesc_mote], 0, sizeof SmartBinC$coordinateX[__nesc_mote]);
  memset((void *)&SmartBinC$coordinateY[__nesc_mote], 0, sizeof SmartBinC$coordinateY[__nesc_mote]);
  memset((void *)&SmartBinC$delay[__nesc_mote], 0, sizeof SmartBinC$delay[__nesc_mote]);
  memset((void *)&SmartBinC$newCoordX[__nesc_mote], 0, sizeof SmartBinC$newCoordX[__nesc_mote]);
  memset((void *)&SmartBinC$newCoordY[__nesc_mote], 0, sizeof SmartBinC$newCoordY[__nesc_mote]);
  memset((void *)&SmartBinC$targetID[__nesc_mote], 0, sizeof SmartBinC$targetID[__nesc_mote]);
  memset((void *)&SmartBinC$closestBin[__nesc_mote], 0, sizeof SmartBinC$closestBin[__nesc_mote]);
  memset((void *)&SmartBinC$smallerDistance[__nesc_mote], 0, sizeof SmartBinC$smallerDistance[__nesc_mote]);
  memset((void *)&SmartBinC$trashInExcess[__nesc_mote], 0, sizeof SmartBinC$trashInExcess[__nesc_mote]);
