...
#line 266
{
  ...
  if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 1) {
      sim_log_debug(216U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(217U, "radio_pack", "ALERT message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(218U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(219U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(220U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(221U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(222U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(223U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(224U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(225U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(226U, "radio_pack", "\n");
      if (!SmartBinC$busy[sim_node()]) {
          ...
          sim_log_debug(227U, "radio_rec", "The truck will be there in %d s.\n", 1 * SmartBinC$delay[sim_node()]);
...
#line 290
        {
          sim_log_debug(228U, "radio_rec", "The truck is busy -> discard the message!\n");
        }
    }

  if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 2) {
      sim_log_debug(229U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(230U, "radio_pack", "TRUCK message>>>Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(231U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(232U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(233U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(234U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(235U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(236U, "radio_rec", "\n ");
      sim_log_debug_clear(237U, "radio_pack", "\n");

      SmartBinC$garbageInBin[sim_node()] = 0;
      sim_log_debug(238U, "SmartBinC", "Emptying bin...\n");
      SmartBinC$AlertTimer$stop();
    }


  if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 3 && TOS_NODE_ID != 0) {
      sim_log_debug(239U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(240U, "radio_pack", "MOVE message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(241U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(242U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(243U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(244U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(245U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(246U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(247U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(248U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(249U, "radio_rec", "\n ");
      sim_log_debug_clear(250U, "radio_pack", "\n");

      if (SmartBinC$garbageInBin[sim_node()] < 85) {
          SmartBinC$delay[sim_node()] = sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2));
          SmartBinC$targetID[sim_node()] = __nesc_ntoh_uint16(mess->bin_id.nxdata);
          SmartBinC$BinTravelTime$startOneShot(0.05 * SmartBinC$delay[sim_node()] * 1000);
          sim_log_debug(251U, "radio_rec", "Bin response will be there in %f s.\n", SmartBinC$delay[sim_node()] * 0.05);
        }
      else 
#line 331
        {
          sim_log_debug(252U, "radio_rec", "Bin in critical status -> discard the message\n");
        }
    }

  if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 4) {
      sim_log_debug(253U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(254U, "radio_pack", "RESP_MOVE message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(255U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(256U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(257U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(258U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(259U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(260U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(261U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(262U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(263U, "radio_rec", "\n ");
      sim_log_debug_clear(264U, "radio_pack", "\n");
      ...
      if (SmartBinC$TimerToCollect$isRunning()) {
          ...
          if (SmartBinC$closestBin[sim_node()] == 0 && SmartBinC$smallerDistance[sim_node()] == 0) {
              ...
              sim_log_debug(265U, "SmartBinC", "Arrived first response. New closestBin: %d, new smallerDistance: %d\n", SmartBinC$closestBin[sim_node()], SmartBinC$smallerDistance[sim_node()]);
            }
          else 
#line 356
            {
              if (SmartBinC$smallerDistance[sim_node()] > sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2))) {
                  SmartBinC$closestBin[sim_node()] = __nesc_ntoh_uint16(mess->bin_id.nxdata);
                  SmartBinC$smallerDistance[sim_node()] = sqrt(pow(SmartBinC$coordinateX[sim_node()] - __nesc_ntoh_uint16(mess->coordX.nxdata), 2) + pow(SmartBinC$coordinateY[sim_node()] - __nesc_ntoh_uint16(mess->coordY.nxdata), 2));
                  sim_log_debug(266U, "SmartBinC", "Arrived another response of a bin closer to me. New closestBin: %d, new smallerDistance: %d\n", SmartBinC$closestBin[sim_node()], SmartBinC$smallerDistance[sim_node()]);
                }
              else 
#line 361
                {
                  sim_log_debug(267U, "SmartBinC", "Arrived response. closestBin: %d, smallerDistance: %d and nothing changed\n", SmartBinC$closestBin[sim_node()], SmartBinC$smallerDistance[sim_node()]);
                }
            }
        }
      else 
#line 365
        {
          sim_log_debug(268U, "SmartBinC", "Received packet but TimerToCollect is over!\n");
        }
    }

  if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 5) {
      sim_log_debug(269U, "radio_rec", "Message received at time %s \n", sim_time_string());
      sim_log_debug(270U, "radio_pack", "TRASH_MOVE message >>> Pack \n \t Payload length %hhu \n", SmartBinC$Packet$payloadLength(buf));
      sim_log_debug_clear(271U, "radio_pack", "\t Source: %hhu \n", SmartBinC$AMPacket$source(buf));
      sim_log_debug_clear(272U, "radio_pack", "\t Destination: %hhu \n", SmartBinC$AMPacket$destination(buf));
      sim_log_debug_clear(273U, "radio_pack", "\t AM Type: %hhu \n", SmartBinC$AMPacket$type(buf));
      sim_log_debug_clear(274U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(275U, "radio_pack", "\t\t msg_type: %hhu \n", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(276U, "radio_pack", "\t\t trashInEccess: %hhu \n", __nesc_ntoh_uint16(mess->trashInEccess.nxdata));
      sim_log_debug_clear(277U, "radio_rec", "\n ");
      sim_log_debug_clear(278U, "radio_pack", "\n");
...
#line 63
{
  ...
  if (err == SUCCESS) {
      sim_log_debug(150U, "radio", "Radio on!\n");
...
#line 90
  ...
  sim_log_debug(151U, "radio_send", "time: %s - sendAlert() - Try to send a request to TRUCK\n", sim_time_string());
  ...
  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(0, &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(158U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(159U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(160U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
...
#line 111
    {
      sim_log_debug(163U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}
...
#line 119
  ...
  sim_log_debug(164U, "radio_send", "time: %s - sendMove() - Try to send a request to all other BINS\n", sim_time_string());
  ...
  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(AM_BROADCAST_ADDR, &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(169U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(170U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(171U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(172U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(173U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
      sim_log_debug_clear(174U, "radio_send", "\n ");
      sim_log_debug_clear(175U, "radio_pack", "\n");
...
#line 141
    {
      sim_log_debug(176U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}
...
#line 148
  ...
  sim_log_debug(177U, "radio_send", "time: %s - sendTruckMessage() - Try to send a response to BIN %d\n", sim_time_string(), SmartBinC$targetID[sim_node()]);
  ...
  if (SmartBinC$AMSend$send(SmartBinC$targetID[sim_node()], &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(179U, "radio_pack", "\t Source: %hhu \n ", SmartBinC$AMPacket$source(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(180U, "radio_pack", "\t Destination: %hhu \n ", SmartBinC$AMPacket$destination(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(181U, "radio_pack", "\t AM Type: %hhu \n ", SmartBinC$AMPacket$type(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(182U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(183U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(184U, "radio_send", "\n ");
      sim_log_debug_clear(185U, "radio_pack", "\n");
    }
}
...
#line 197
  ...
  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(SmartBinC$closestBin[sim_node()], &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(201U, "radio_pack", "\t Source: %hhu \n ", SmartBinC$AMPacket$source(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(202U, "radio_pack", "\t Destination: %hhu \n ", SmartBinC$AMPacket$destination(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(203U, "radio_pack", "\t AM Type: %hhu \n ", SmartBinC$AMPacket$type(&SmartBinC$packet[sim_node()]));
      sim_log_debug_clear(204U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(205U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(206U, "radio_pack", "\t\t trashInEccess: %hhu \n", __nesc_ntoh_uint16(mess->trashInEccess.nxdata));
...
#line 217
    {
      sim_log_debug(209U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}
...
#line 167
  ...
  sim_log_debug(186U, "radio_send", "time: %s - sendMoveResponse() - Try to send a response to BIN %d\n", sim_time_string(), SmartBinC$targetID[sim_node()]);
  ...
  if (!SmartBinC$busy[sim_node()] && SmartBinC$AMSend$send(SmartBinC$targetID[sim_node()], &SmartBinC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(193U, "radio_pack", "\t\t bin_id: %hhu \n", __nesc_ntoh_uint16(mess->bin_id.nxdata));
      sim_log_debug_clear(194U, "radio_pack", "\t\t coordX: %hhu \n", __nesc_ntoh_uint16(mess->coordX.nxdata));
      sim_log_debug_clear(195U, "radio_pack", "\t\t coordY: %hhu \n", __nesc_ntoh_uint16(mess->coordY.nxdata));
...
#line 189
    {
      sim_log_debug(198U, "radio_send", "time: %s - sendAlert() - Cannot send because of concurrent sending of another message\n", sim_time_string());
    }
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb72c6a98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb72c6a98) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb72c6a98, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb72c3498, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb72c3498, addr, msg, len);
#line 80
...
#line 409
{
  ...
  if (SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] < 85) {
    ...
    if (SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] >= 85 && SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] < 100) {
        ...
        SmartBinC$garbageInBin[sim_node()] = SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()];
        sim_log_debug(284U, "SmartBinC", "time: %s - Adding garbage: %d, Eccess already present: %d, Garbage level: %d -> Critical status\tNext time: %d\n", sim_time_string(), SmartBinC$garbageToAdd[sim_node()], SmartBinC$trashInEccess[sim_node()], SmartBinC$garbageInBin[sim_node()], SmartBinC$time[sim_node()]);
...
#line 433
      if (SmartBinC$garbageInBin[sim_node()] + SmartBinC$garbageToAdd[sim_node()] >= 100) {
          ...
          SmartBinC$garbageInBin[sim_node()] = 100;
          sim_log_debug(285U, "SmartBinC", "time: %s - Adding garbage: %d, Eccess already present: %d, Garbage level: %d-> Full status\tNext time: %d\n", sim_time_string(), SmartBinC$garbageToAdd[sim_node()], SmartBinC$trashInEccess[sim_node()], SmartBinC$garbageInBin[sim_node()], SmartBinC$time[sim_node()]);
...
#line 397
{
  ...
  sim_log_debug(281U, "SmartBinC", "TruckTravelTime fired -> Truck is arrived at coordinates: (%d, %d)\n", SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()]);
...
#line 404
{
  sim_log_debug(282U, "SmartBinC", "BinTravelTime fired\n");
...
#line 445
{
  sim_log_debug(286U, "SmartBinC", "TimerToCollect is over!\n");
  if (SmartBinC$closestBin[sim_node()] == 0 && SmartBinC$smallerDistance[sim_node()] == 0) {
      sim_log_error(287U, "SmartBinC", "It has not been found an available bin near to me\n");
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb732ac70){
#line 83
  switch (arg_0xb732ac70) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb732ac70);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(314U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(313U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(310U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(311U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(303U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(293U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(300U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 91
{
  ...
  sim_log_debug(315U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(316U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(317U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = 1;
      ...
      sim_log_debug(318U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 364
{
  sim_log_debug(305U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 49
{
  ...
  sim_log_debug(149U, "boot", "Coordinates of the mote are: (%d, %d)\n", SmartBinC$coordinateX[sim_node()], SmartBinC$coordinateY[sim_node()]);
...
#line 285
  ...
  sim_log_debug(302U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(308U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 226
  ...
  if (&SmartBinC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(210U, "radio_send", "Packet of type %d sent...", __nesc_ntoh_uint8(mess->msg_type.nxdata));


      if (SmartBinC$PacketAcknowledgements$wasAcked(buf)) {
          if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 2) {
              sim_log_debug_clear(211U, "radio_ack", "and ack received");
              SmartBinC$busy[sim_node()] = FALSE;
            }

          if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 5) {
              sim_log_debug_clear(212U, "radio_ack", "and ack received");
...
#line 245
        {
          ...
          if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 2) {
              sim_log_debug_clear(213U, "radio_ack", "but ack was not received");
              SmartBinC$sendTruckMessage$postTask();
            }

          if (__nesc_ntoh_uint8(mess->msg_type.nxdata) == 5) {
              sim_log_debug_clear(214U, "radio_ack", "but ack was not received");
              SmartBinC$sendTrashMove$postTask();
            }
        }
      sim_log_debug_clear(215U, "radio_send", " at time %s \n", sim_time_string());
    }
}
...
#line 101
      sim_log_debug(288U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(289U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(290U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(291U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(309U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(312U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(301U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
